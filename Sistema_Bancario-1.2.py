...
def sacar():
    """Realizar a operação de saque, verificando o saldo."""
    global sado # Indica que a variável global saldo está modificando
...
while not opcao_str.isdigit() or not (1 <= int(opcao_str) <= 4):
    ...
    opcao_str = unput("Digite a opção desejada: ")
